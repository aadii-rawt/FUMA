            ...
            <div className="w-1/2 p-6">
                ...
                <div className="mt-10">
                    ...
                    {error && <p className="text-red-500 mt-1 text-sm">{error}</p>}
                        <button onClick={handleSignup} className="border w-full text-center py-1.5 cursor-pointer border-gray-200 mt-5 rounded-xl bg-violet-700 text-white">{loading ? <LoadingSpinner size={22} /> : "Sign In" }</button>
