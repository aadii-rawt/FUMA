// index.js (or index.ts with types adjusted)
import express from "express";
import cors from "cors";
import cookieParser from "cookie-parser";
import serverless from "serverless-http";

// Load .env locally only; on Vercel, envs come from dashboard
...
// Behind Vercel/Proxies (needed for secure cookies, correct IPs, etc.)
app.set("trust proxy", 1);

// Cookies first
app.use(cookieParser());

// Keep raw body ONLY for /webhook (important for signature verification)
// Must come BEFORE json/bodyParser for that path
...
// If no origins were provided, allow all (useful during testing/preview)
...
<body>
  <div class="container">
    ...
    <p>This Privacy Policy describes the policies and procedures of <strong>${company}</strong> (“Company”, “we”, “us”, or “our”) on the collection, use, and disclosure of your information when you use our website, apps, and related services (the “Service”), and explains your privacy rights and how the law protects you. By using the Service, you agree to this Privacy Policy.</p>
    ...
    <h3>Contact Us</h3>
    <p>Email: <a href="mailto:${contactEmail}">${contactEmail}</a><br/>Address: ${companyAddress}</p>
    <hr/>
...
// Your webhook handler (keep .raw above)
